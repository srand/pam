...
gcc.add_feature(PyBuildProjectDeps.ALL)
...
gcc_mk.add_tool('.S', PyBuildCXXCompiler(cxx=False))
gcc_mk.add_tool('.c', PyBuildCXXCompiler(cxx=False))
gcc_mk.add_tool('.cc', PyBuildCXXCompiler(cxx=True))
gcc_mk.add_tool('.cpp', PyBuildCXXCompiler(cxx=True))
gcc_mk.add_tool('.cxx', PyBuildCXXCompiler(cxx=True))
...
gcc_mk.add_feature(PyBuildProjectDeps.ALL)
