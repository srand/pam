...
macosx_x86.add_cflag('-m32')
macosx_x86.add_cxxflag('-m32')
macosx_x86.add_linkflag('-m32')
...
macosx_x64.add_cflag('-m64')
macosx_x64.add_cxxflag('-m64')
macosx_x64.add_linkflag('-m64')
